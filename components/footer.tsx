        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Sharing AI-generated stories that inspire, entertain, and connect us all. Our stories are crafted with
              artificial intelligence but represent authentic narratives and experiences.
            </p>
          </div>
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about-our-stories" className="text-sm text-muted-foreground hover:text-foreground">
                  About Our Stories
                </Link>
              </li>
            </ul>
